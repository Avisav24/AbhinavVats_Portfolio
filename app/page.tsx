          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            {[
              ...
              <motion.div
                ...
                className="liquid-glass backdrop-blur-[25px] rounded-[32px] p-[32px] hover:bg-[#6FFF00]/10 hover:border-[#6FFF00]/50 hover:shadow-[0_0_30px_rgba(111,255,0,0.1)] hover:-translate-y-2 transition-all duration-300 w-full group flex flex-col justify-between"
                data-hover-sfx="true"
              >
                <div>
        ...
        <div className="w-full max-w-[1831px] px-6 md:px-12 lg:px-24">
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <motion.div
              ...
              className="liquid-glass rounded-[32px] p-[32px] hover:bg-white/10 transition-colors w-full flex flex-col md:flex-row justify-between items-start md:items-center"
            >
              <div>
        ...
        <div className="w-full max-w-[1831px] px-6 md:px-12 lg:px-24">
          <div className="flex flex-col md:flex-row justify-between md:items-end mb-16 gap-8">
            ...
            <div className="flex flex-col items-start cursor-pointer group">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-start gap-4 liquid-glass px-8 py-4 rounded-[20px] hover:bg-white/10 transition-colors pointer-events-auto"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="liquid-glass rounded-[32px] p-[18px] hover:bg-white/10 transition-colors group cursor-pointer flex flex-col h-full"
              data-hover-sfx="true"
            >
              <div className="relative w-full pb-[100%] rounded-[24px] overflow-hidden mb-4 relative z-0">
                <video
                  autoPlay
                  loop
                  muted
              ...
              <div className="liquid-glass rounded-[20px] px-5 py-4 flex justify-between items-center mt-auto">
                <div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.4 }}
              className="liquid-glass backdrop-blur-[25px] rounded-[32px] p-[18px] hover:bg-white/10 transition-colors group cursor-pointer flex flex-col h-full"
              data-hover-sfx="true"
            >
              <div className="relative w-full pb-[100%] rounded-[24px] overflow-hidden mb-4 relative z-0">
                <video
              ...
              <div className="liquid-glass backdrop-blur-[25px] rounded-[20px] px-5 py-4 flex justify-between items-center mt-auto">
                <div>
                  <div className="text-[11px] text-[#EFF4FF]/70 mb-1 tracking-wider">
                    TECH STACK:
                  </div>
      ...
      >
        ...
        >
          ...
          <form
            ...
            className="liquid-glass backdrop-blur-[25px] rounded-[1.25rem] p-4 md:p-5 flex flex-col md:flex-row items-center gap-4 h-full md:h-[5rem]"
          >
            <input
              name="message"
              type="text"
